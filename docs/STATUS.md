...
- **Current step:** Product source `4d223ee7f4bd8ed536b2238616c2ac1a23ae3584f66a5869197b0afc349a0d8a` is rolled up on private `main`. Clean unsigned release executable `ee876b51aec617563963ee898c6ec36f87a3dffbfc10c2dc2636182c8a7a0442` passed the arm64 iPhoneOS, iOS 15, both-device-family, personal-path, ROM/save, no-dynamic-code, and package audits. Two deterministic packages of `BananaPad-v0.1.0-preview.1-unsigned.ipa` matched byte-for-byte at SHA-256 `a7f3a7a280770644bb175553c2d70c5af032959fd1e425d89b164f721b53d55e`. Signed hardware executable `0cf47f413d544a59d6fd7b96b4838a4325b03044bd40f217226b47711f1b5abd` remains installed in place with the user's ROM/save/preferences preserved; the unsigned release build did not alter that device container.
...
Do not replay DK64 progression without a named BananaPad regression. The private-main source rollup and first exact local IPA candidate are complete. A visibility change, public tag/release, IPA upload, and hosted-byte check remain separate publication actions. Product-quality work continues through the remaining hands-on G12 worksheet: controller reconnect, audible audio routes/interruptions, sustained thermal/memory behavior, and icon appearances. Simulator gameplay is not a substitute.
