...
- **Active goal:** publish and verify BananaPad Preview 1, then continue physical controller/audio/soak coverage independently as preview-quality work.
...
| G12–G13 | G12 started; G13 Preview 1 authorized | Signed iPad build/install/launch and visible DK64 rendering pass with an artifact-bound preflight receipt. G12 still requires the worksheet's controller reconnect, audible audio routes/interruptions, memory pressure, and sustained-operation checks. G13 public source/tag/prerelease/IPA/checksum publication is explicitly authorized and complete subject to hosted-byte verification. |
