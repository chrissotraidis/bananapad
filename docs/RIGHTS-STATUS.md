...
Preview 3 publication is complete. The hosted IPA and checksum were downloaded without GitHub authentication, matched the audited local artifacts byte-for-byte, and passed fresh checksum, ZIP, package, and no-dynamic-code audits.
